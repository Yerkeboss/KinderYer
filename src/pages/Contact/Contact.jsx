        ...
        <div className='contact-page'>
            <header className='height-75'>
                <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                    <h1 className='container2 text-center fw-semibold'style ={{marginTop:'6rem'}}>{t('contactus')}</h1>
                    <p className='text-center w-75 mb-5' style={{ marginTop: '2rem', fontWeight: 'bold', fontSize: '1.2rem' }}>{t('address')}</p>
                    <p className='text-center w-75 mb-5' style={{ marginTop: '0rem', fontWeight: 'bold', fontSize: '1.2rem' }}>+7 705 565 6404</p>
                    <p className='text-center w-75 mb-5' style={{ marginTop: '0rem', fontWeight: 'bold', fontSize: '1.2rem' }}>Email: ersan.zhanai22@yandex.kz</p>
                </div>
            </header>
